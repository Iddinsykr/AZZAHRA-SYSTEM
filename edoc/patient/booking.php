...
$userfetch = $result->fetch_assoc(); // fixed line
...
<div class="container">
    ...
    <div class="dash-body">
        <table border="0" width="100%" style="border-spacing:0;margin-top:25px;">
            ...
            <tr><td colspan="4" style="padding-top:10px;width:100%;"></td></tr>
            <tr>
                <td colspan="4">
                    <center>
                                            ...
                                            <td style="width:25%;">
                                                <div class="dashboard-items search-items">
                                                    <div style="width:100%;padding:15px;">
                                                        <div class="h1-search" style="font-size:20px;line-height:35px;text-align:center;">Your Appointment Number</div>
                                                        <center>
